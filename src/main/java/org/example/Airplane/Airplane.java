...
public class Airplane {
    ...
    public Airplane(String airline, int passengerCapacity, int registrationNumber, String status, String idGate) {
        this.id = Utils.getID();
    ...
    public void setIdGate(String idGate) throws Exception{
